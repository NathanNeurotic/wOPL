...
#ifdef __DEBUG
    {UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_BDM_DEBUG}}},
    {UI_SPACER},
    {UI_BOOL, CFG_BDM_DEBUG, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}},
    {UI_BREAK},
#endif
...
struct UIItem diaUIConfig[] = {
    ...
    {UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_ARCHIVEDART}}},
    {UI_SPACER},
    {UI_BOOL, UICFG_ARCHIVEDART, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}},
    {UI_BREAK},
...
struct UIItem diaCompatConfig[] = {
    ...
    {UI_SPACER},
    {UI_ENUM, COMPAT_MODULAR_CORE_VERSION, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}},
    {UI_SPLITTER},
    ...
    {UI_SPACER},
    {UI_LABEL, COMPAT_MODE_9_STR, 1, 1, -1, 0, 0, {.label = {NULL, _STR_MODE9}}},
    {UI_SPACER},
    {UI_BOOL, COMPAT_MODE_BASE + 8, 1, 1, _STR_HINT_MODE9, -10, 0, {.intvalue = {0, 0}}},
